...
func encodeDomainDeleteFactByTupleResponse(response DomainDeleteFactByTupleRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *DomainDeleteFactByTupleOK:
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
	...
	case *DomainDeleteFactByTupleMethodNotAllowed:
		w.WriteHeader(405)
		span.SetStatus(codes.Error, http.StatusText(405))
...
func encodeDomainGetEncryptionSettingsResponse(response DomainGetEncryptionSettingsRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
...
func encodeDomainGetExternalRootEncryptionKeyResponse(response DomainGetExternalRootEncryptionKeyRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *RootEncryptionKeyItem:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
...
func encodeDomainGetIdentityGroupProvidersResponse(response DomainGetIdentityGroupProvidersRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *DomainIdentityGroupProviderDetails:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeDomainPutEncryptionSettingsResponse(response DomainPutEncryptionSettingsRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *DomainPutEncryptionSettingsOK:
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeKeychainCreateWorkspaceResponse(response KeychainCreateWorkspaceRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *WorkspaceInfo:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
...
func encodeKeychainGetWorkspaceInfoResponse(response KeychainGetWorkspaceInfoRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *WorkspaceInfo:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
...
func encodeKeychainGetWorkspaceObjectsResponse(response KeychainGetWorkspaceObjectsRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *WorkspaceObjectList:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeKeychainPutWorkspaceObjectsResponse(response KeychainPutWorkspaceObjectsRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *KeychainPutWorkspaceObjectsOK:
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
